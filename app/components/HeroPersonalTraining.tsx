    ...
    >
      ...
      >
        <Image
          ...
          alt="Personal Training Potentia Gym"
          fill
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-16">
          <div className="max-w-[440px]">
            ...
            >
              Personal Training in Maarheeze voor het beste resultaat
            </h1>
...
export default HeroPersonalTraining;